    ...
    abstract class module extends baseObject {
        ...
        public function __construct($d, $params = array()) {
            ...
            if(isset($d['ex_plug_dir']) && !empty($d['ex_plug_dir'])) {
                ...
                $this->setExternalDir( utils::getExtModDir($d['ex_plug_dir']) );
                $this->setExternalPath( utils::getExtModPath($d['ex_plug_dir']) );
            }
        }
        ...
        public function getModDir() {
            if(empty($this->_externalDir)) {
                return S_MODULES_DIR. $this->getCode(). DS;
            } else {
        ...
        public function getModPath() {
            if(empty($this->_externalPath)) {
                return S_MODULES_PATH. $this->getCode(). '/';
            } else {
        ...
        public function init() {
            /**
             * @deprecated
             * Now this is for revrite only
             */
            /*$this->_createController();
            $page = req::getAdminPage();
            if($page == $this->_code) {
                $this->_onAdmin = true;
            }*/
        }
        ...
        protected function _createController() {
            ...
            if(file_exists($this->getModDir(). 'controller.php')) {
                $class = $this->getCode(). 'Controller';
                importClass($class, $this->getModDir(). 'controller.php');
                if(class_exists($class)) {
                    $this->_controller = new $class($this->_code);
        ...
        protected function _createHelper() {
            ...
            if (file_exists($this->getModDir().'helper.php')) {
                ...
                importClass($helper, $this->getModDir(). 'helper.php');
        ...
        public function __call($name, $arguments) {
            ...
            errors::push(lang::_(array('Module', $this->_code, 'method', $name, 'undefined')), errors::FATAL);
        }
