	...
	class fileuploader {
		...
		public function upload() {
            ...
            if (!empty($upload['type'])) {
                ...
                $this->_fileInfo['id'] = frame::_()->getTable('product_files')->insert($data_to_store);
                $res = true;
            }
        ...
        private function createFileName() {
            return utils::getRandStr(). '-'. utils::getRandStr(). '-'. utils::getRandStr(). '-'. utils::getRandStr();
        }
        /**
